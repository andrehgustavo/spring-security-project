DROP DATABASE  IF EXISTS `md7_spring_project_crm`;

CREATE DATABASE  IF NOT EXISTS `md7_spring_project_crm`;
USE `md7_spring_project_crm`;
...
VALUES 
('ROLE_EMPLOYEE'),('ROLE_ENGINEER'),('ROLE_ADMIN');
